...
#        input('choose a valid option')
    ...
    if (imodel == '1'):
        ...
        i_location = int(input('Your choice?'))
#elif ssystem == '3':
    print('(1)SPARCstation 5','    (7)AlphaServer 2100')
    print('(2)SPARCstation 10','   (8)AlphaServer 4100')
    print('(3)SPARCstation 20','    (9)AlphaServer DS10')
    print('(4)Ultra 1','   (10)AlphaServer DS20')
    print('(5)Ultra 2','   (11)AlphaServer ES40')
    print('(6)AlphaServer 4000','   (12)AlphaServer GS80/160/320')
    imodel = input('your choice? ')
#else ssystem == '4'
else:
